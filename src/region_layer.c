...
void c_get_region_boxes(layer l, int w, int h, float thresh, float **probs, box *boxes, int only_objectness, int *map, float tree_thresh){
    get_region_boxes(l,w,h,thresh,probs,boxes,only_objectness,map,tree_thresh);
}
