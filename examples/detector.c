...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    network net = load_network(cfgfile, weightfile, 0);
    set_batch_network(&net, 1);
    printf("LOAD NETWORK & SET BATCH NETWORK COMPLETED \n");
    srand(2222222);
    double time;
    char buff[256];
    char *input = buff;
	...
	printf("SIZED -> %i %i %i %5.1f  \n", sized.w, sized.h, sized.c, *sized.data);
...
{
	printf("ENTRA AQUI! run_detector !!!!  \n");
...
void c_test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
